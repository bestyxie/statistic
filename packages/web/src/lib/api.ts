...
import type { Shop, Product, DashboardData, ExternalProduct, ExternalData, Visitor, ProductLabel, LabelProductStat, LabelSalesItem, LabelTrendItem, LabelTxTrendItem } from '@statistic/shared'
